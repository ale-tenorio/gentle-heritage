...
const PRODUCTS = [
  { id:1,  name:'Linen Shirt Dress',     price:89,  cat:'Dresses',            cond:'new',        sizes:['XS','S','M'],        note:"Hits at knee on 5'2\" — ideal midi length",           img:'https://picsum.photos/seed/gh-linen-dress/600/800', g:['#E8D8C2','#C4A87A'] },
  { id:2,  name:'Vintage Denim Jacket',  price:45,  cat:'Outerwear',          cond:'secondhand', sizes:['S','M'],             note:'Cropped fit, great for petite frames',                img:'https://picsum.photos/seed/gh-denim-jacket/600/800', g:['#D6CCBE','#A89074'] },
  { id:3,  name:'Ribbed Tank Set',       price:68,  cat:'Sets / co-ords',     cond:'new',        sizes:['XS','S','M','L'],    note:'High-waist trousers elongate the leg',                img:'https://picsum.photos/seed/gh-ribbed-set/600/800', g:['#DED0C0','#B8A48C'] },
  { id:4,  name:'Wide Leg Trousers',     price:72,  cat:'Jeans & trousers',   cond:'new',        sizes:['XS','S','M'],        note:'Petite inseam available',                             img:'https://picsum.photos/seed/gh-wide-trousers/600/800', g:['#CEC4B0','#A89880'] },
  { id:5,  name:'Wrap Mini Skirt',       price:38,  cat:'Skirts',             cond:'secondhand', sizes:['XS','S'],            note:'Sits high — flattering on shorter legs',              img:'https://picsum.photos/seed/gh-wrap-skirt/600/800', g:['#D4C4B8','#B09488'] },
  { id:6,  name:'Cashmere Crewneck',     price:120, cat:'Tops',               cond:'new',        sizes:['XS','S','M'],        note:'Slightly cropped — perfect proportions',              img:'https://picsum.photos/seed/gh-cashmere/600/800', g:['#E0DAD4','#C4BEB8'] },
  { id:7,  name:'Satin Slip Dress',      price:95,  cat:'Dresses',            cond:'new',        sizes:['XS','S'],            note:"Short length works well at 5'4\" and under",          img:'https://picsum.photos/seed/gh-satin-slip/600/800', g:['#D4C4C0','#B4A0A0'] },
  { id:8,  name:"Vintage Levi's 501s",   price:55,  cat:'Jeans & trousers',   cond:'secondhand', sizes:["W24","W25","W26"],   note:'Shortened hem — ready to wear',                       img:'https://picsum.photos/seed/gh-levis-501/600/800', g:['#D2C8BA','#A48C72'] },
  { id:9,  name:'Boxy Blazer',           price:85,  cat:'Outerwear',          cond:'secondhand', sizes:['XS','S','M'],        note:'Oversized on petite frames is very intentional here',  img:'https://picsum.photos/seed/gh-boxy-blazer/600/800', g:['#C4C0BC','#A4A09C'] },
  { id:10, name:'Broderie Blouse',       price:62,  cat:'Tops',               cond:'new',        sizes:['XS','S','M'],        note:'Cropped hem hits at natural waist',                    img:'https://picsum.photos/seed/gh-broderie/600/800', g:['#E4DDD4','#CCC0B0'] },
  { id:11, name:'Mary Jane Flats',       price:48,  cat:'Shoes & accessories', cond:'new',       sizes:['35','36','37','38'], note:'Low heel adds height subtly',                         img:'https://picsum.photos/seed/gh-mary-jane/600/800', g:['#CCC4BC','#ACA49C'] },
  { id:12, name:'Pleated Mini Skirt',    price:44,  cat:'Skirts',             cond:'new',        sizes:['XS','S','M'],        note:"Mini length perfect for 5'4\" and under",             img:'https://picsum.photos/seed/gh-pleated-skirt/600/800', g:['#DEDAD4','#C0BCB4'] },
];
